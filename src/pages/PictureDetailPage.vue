  ...
  <div id="pictureDetailPage">
    <a-row :gutter="[16, 16]">
      ...
      <a-col :sm="24" :md="8" :xl="6">
        <a-card title="图片信息">
          <a-image style="max-height: 600px; object-fit: contain"></a-image>
...
import { ShareAltOutlined, DeleteOutlined, DownloadOutlined, EditOutlined } from '@ant-design/icons-vue'
